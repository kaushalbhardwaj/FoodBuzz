...
public class MySqliteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into " + TBName + " values('m111','Aloo Sandwich','Omlette\nBread Butter/Jam');");
        db.execSQL("insert into " + TBName + " values('m112','Chole Bhature','Roti\nPlain Rice\nBundi Raita\nFried Mirch');");
        db.execSQL("insert into " + TBName + " values('m113','Aloo Pakoda','Ketchup\nThandai\nTea');");
        ...
        db.execSQL("insert into " + TBName + " values('m142','Kadi','Lauki Kofta\nPlain Rice\nPapad');");
        db.execSQL("insert into " + TBName + " values('m143','Samosa','Ketch Up\nLemon Water\nTea');");
        db.execSQL("insert into " + TBName + " values('m144','Kadai Paneer','Arhar Dal\nBundi Ladoo\nMissi Roti');");

        db.execSQL("insert into " + TBName + " values('m151','Pav Bhaji','Omlette\nBread Butter/jam');");
        db.execSQL("insert into " + TBName + " values('m152','Aloo Bhujia','Dal Tadka\nOnion Rice\nPlain Curd');");
        ...
        db.execSQL("insert into " + TBName + " values('m164','Dal Makhani','Aloo Palak\nFruit Custard\nPlain Rice');");
        ...
        db.execSQL("insert into " + TBName + " values('m211','Aloo Sandwich','Omlette\nBread Butter/Jam');");
        db.execSQL("insert into " + TBName + " values('m212','Chole Bhature','Roti\nPlain Rice\nBundi Raita\nFried Mirch');");
        ...
        db.execSQL("insert into " + TBName + " values('m242','Kadi','Lauki Kofta\nPlain Rice\nPapad');");
        db.execSQL("insert into " + TBName + " values('m243','Samosa','Ketch Up\nLemon Water\nTea');");
        db.execSQL("insert into " + TBName + " values('m244','Kadai Paneer','Arhar Dal\nBundi Ladoo\nMissi Roti');");

        db.execSQL("insert into " + TBName + " values('m251','Pav Bhaji','Omlette\nBread Butter/jam');");
        db.execSQL("insert into " + TBName + " values('m252','Aloo Bhujia','Dal Tadka\nOnion Rice\nPlain Curd');");
        ...
        db.execSQL("insert into " + TBName + " values('m264','Dal Makhani','Aloo Palak\nFruit Custard\nPlain Rice');");
